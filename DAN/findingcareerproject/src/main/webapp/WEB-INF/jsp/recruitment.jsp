        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div id="jobinfor" class="container tab-pane active">
                    <div class="jobinfor">
                        <div class="wrap-infor" id="description" style="width: 80%">
                            <div class="section">
                                <label>WHAT WE CAN OFFER</label>
                                <div class="offer">
                                    <c:forEach var="we" items="${welfare}">
                                        <i class="fa fa-check" aria-hidden="true"></i> ${we}<br>
                                    </c:forEach>
                                </div>
                        </div>
                        <div class="section">
                            ...
                            <div class="mt-2 description">
                                <c:forEach var="de" items="${description}">
                                    - ${de}<br>
                                </c:forEach>
                            </div>
                        </div>
                        <div class="section">
                            ...
                            <div class="mt-2 requirement">
                                <c:forEach var="re" items="${requirement}">
                                    <i class="fa fa-circle-o" aria-hidden="true"></i> ${re}<br>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
            ...
            <div id="companyinfor" class="container tab-pane fade">
                <div class="companyinfor">
                    <div class="wrap-infor" id="description" style="width: 80%">
                        <div class="section">
                            <div class="imgs mt-2">
                                <img style="width: 600px; height: 380px;" src="${co.companyImg}"
    ...
    <div class="container recommend"> 
                    ...
                    <div class="icon-box">
                        <div class="box1" style="height: 300px">
                            <div class="infor-section">
                                <div class="ti">
                                    <h4 class="title-com" style="width: 90%; height: max-content">
        ...
        <div class="row same-recruitment">
            <c:forEach var="r" items="${sameCates}">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box">
                        <div class="box1" style="height: 250px">
                            <div class="infor-section">
                                <div class="ti">
                                    <h4 class="title-com" style="width: 90%; height: max-content">
